...
3. Create access keys for _IamUserName_. Disable temp credentials on cloud9 and aws configure with new credentials.
...
7. Add the AWS EC2 Key pair to the cloud9 instance.
