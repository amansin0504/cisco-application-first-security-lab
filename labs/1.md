...
5. Use the _PodName_, _PodPassword_, _SwcSecret_, _DuoSecret_, and _DevNetEmail_ values provided in the Sandbox reservation email for the _Parameters_ fields. For the _KeyPairName_, select the key pair name you provided in _step 1_
