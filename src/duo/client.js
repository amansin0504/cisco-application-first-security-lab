 ...
 function login() {
    ...
    $.ajax({
        ...
        success: function (data, textStatus, jqXHR) {
            ...
            $("#login-message").html('<div class="alert alert-success">Redirecting to Duo.</div>');
            //DUO
...
function register() {
	...
	data: postvals,
        success: function (data, textStatus, jqXHR) {
            ...
            $("#registration-message").html('<div class="alert alert-success">Registration complete. Redeirecting to Duo.</div>');
            //DUO
            console.log('posted: ' + textStatus);
            console.log("logged_in cookie: " + $.cookie('logged_in'));
            //DUO
